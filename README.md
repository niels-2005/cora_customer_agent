...
- **LLM Fine-tuning** - Fine-tune models using libraries like Transformers and QLoRA to eliminate RAG components and reduce inference time. Trade-offs: Fine-tuning is expensive and requires retraining when new products/FAQs are added. For this use case, RAG is prioritized over fine-tuning due to flexibility and maintainability
